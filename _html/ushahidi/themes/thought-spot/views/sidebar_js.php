$( document ).ready(function() {
	...
	//insert sidebar on pages with .main-content
		...
		$(".main-content .section h2:first-child").each(function() { // getting all h2 headers from the content
			...
			if (linkTitle != "Twitter") {// this is a terrible hack, but whattayagonnado
