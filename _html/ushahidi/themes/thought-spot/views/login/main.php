...
<div id="openid_login_container">
	...
	<div id="ushahidi_site_name" class="ui-corner-all">
    	<div id="logo">
			...
			<span><?php echo $site_tagline; ?><br /></span>
			<p><br />Thought Spot accounts are only available for verified users and workshop participants. <a href="/contact">Contact us</a> to get involved today.</p>
		</div>
    </div>
